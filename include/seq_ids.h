...
enum SeqId {
    ...
    SEQ_STREAMED_RESURRECTION,
    SEQ_STREAMED_RESURRECTION_RAIN,
    SEQ_STREAMED_RESURRECTION_CHASE,
    SEQ_STREAMED_ANCIENT_TOWN,
    SEQ_STREAMED_TARREY_TOWN_1,
    SEQ_STREAMED_MAGNUS,
    SEQ_STREAMED_SCRAMBLE,
    SEQ_STREAMED_TARREY_TOWN_2,
    SEQ_STREAMED_URGENCY,
    SEQ_COUNT
};
