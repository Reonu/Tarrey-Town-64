COURSE_ACTS(COURSE_BOB, _("   THE CITY"),
       _("RESCUE THE TOADS!")     , _("FOOTRACE WITH KOOPA THE QUICK") , _("SHOOT TO THE ISLAND IN THE SKY"),
       _("FIND THE 8 RED COINS")          , _("MARIO WINGS TO THE SKY")        , _("BEHIND CHAIN CHOMP'S GATE"))

COURSE_ACTS(COURSE_WF, _("   THE MOUNTAINS"),
       _("RECRUIT THE MINERS!")        , _("TO THE TOP OF THE FORTRESS")    , _("SHOOT INTO THE WILD BLUE"),
...
CASTLE_SECRET_STARS(_("   TARREY TOWN"))
