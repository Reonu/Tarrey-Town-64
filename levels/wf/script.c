...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, -14888, 274, 38, 0, 0, 0, 0x00000000, bhvCutsceneHandler),
		OBJECT(MODEL_GOOMBA, -10626, 1034, -1305, 0, 0, 0, 0x01000000, bhvGoomba),
		OBJECT(MODEL_NONE, -14306, 274, 38, 0, 0, 0, 0x00020000, bhvBirdsSoundLoop),
		OBJECT(MODEL_NONE, -14545, 610, -1292, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -14545, 610, -1292),
