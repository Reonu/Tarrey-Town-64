...
const LevelScript level_bob_entry[] = {
	...
	AREA(3, bob_area_3),
		...
		OBJECT(MODEL_NONE, 10604, 2510, 913, 0, 0, 0, 0x007F0000, bhvCannon),
		OBJECT(MODEL_CHUCKYA, 6297, 4331, -1421, 0, 0, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, 2595, 5538, -1149, 0, 0, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -3619, 5538, -1150, 0, 0, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_GREEN_SPRING, 12726, 0, 301, 0, 0, 0, 0x01000000, bhvGreenSpring),
		OBJECT(MODEL_NONE, 12648, 593, 321, 0, 0, 0, 0x01000000, bhvLamp),
		OBJECT(MODEL_NONE, -6485, 6803, 255, 0, 0, 0, 0x00000000, bhvLamp),
		OBJECT(MODEL_NONE, 4015, 6051, -1793, 0, 0, 0, 0x00000000, bhvLamp),
		OBJECT(MODEL_NONE, 11980, 1543, 1059, 0, 0, 0, 0x007F0000, bhvLightingBolt),
		OBJECT(MODEL_NONE, 12686, 464, 472, 0, 0, 0, 0xFFFF0000, bhvPoleGrabbing),
		OBJECT(MODEL_NONE, 12726, 0, 499, 0, 0, 0, 0x02000000, bhvBirdsSoundLoop),
		OBJECT(MODEL_NONE, 14022, 0, 9, 0, 0, 0, 0x000A0000, bhvInstantActiveWarp),
		OBJECT(MODEL_YELLOW_SPRING, 5055, 4599, -1559, 0, 0, 0, 0x00000000, bhvGreenSpring),
		OBJECT(MODEL_YELLOW_SPRING, -8450, 5612, -2853, 0, 0, 0, 0x00000000, bhvGreenSpring),
