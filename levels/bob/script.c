...
const LevelScript level_bob_entry[] = {
	...
	AREA(2, bob_area_2),
		...
		WARP_NODE(0xF0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		INSTANT_WARP(0x00, 0x03, -9081, -1353, -7489),
	...
	AREA(3, bob_area_3),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -2066, 890, 482, 0, 0, 0, 0x01000000, bhvLamp),
		OBJECT(MODEL_NONE, -2008, 697, 708, 0, 0, 0, 0xFFFF0000, bhvPoleGrabbing),
		OBJECT(MODEL_NONE, -1948, 0, 750, 0, 0, 0, 0x01000000, bhvBirdsSoundLoop),
		OBJECT(MODEL_NONE, -2, 0, 14, 0, 0, 0, 0x000A0000, bhvInstantActiveWarp),
