...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_NONE, -1467, -236, -1410, 0, 0, 0, 0x00000000, bhvCutsceneHandler),
	...
	AREA(2, bob_area_2),
		...
		OBJECT(MODEL_NONE, 9672, -563, -1060, 0, 0, 0, 0x00000000, bhvLamp),
		OBJECT(MODEL_NONE, 9076, -563, -1060, 0, 0, 0, 0x00000000, bhvBirdsSoundLoop),
		OBJECT(MODEL_WOOD_PLATFORM, 9076, -1047, -13, 0, 0, 0, 0x06000000, bhvWoodPlatform),
		OBJECT(MODEL_WOOD_PLATFORM, 2777, -1047, -13, 0, 0, 0, 0x06000000, bhvWoodPlatform),
		OBJECT(MODEL_WOOD_PLATFORM, 367, -1047, -13, 0, 0, 0, 0x04000000, bhvWoodPlatform),
		OBJECT(MODEL_WOOD_PLATFORM, 1727, -1047, -13, 0, 0, 0, 0x05000000, bhvWoodPlatform),
