...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_KOOPA_WITH_SHELL_CUSTOM, 3010, 0, 2768, 0, -92, 0, 0x07200000, bhvKoopaToad),
		OBJECT(MODEL_KOOPA_WITH_SHELL_CUSTOM, -4575, 634, 2902, 0, 0, 0, 0x07000000, bhvKoopaToad),
		OBJECT(MODEL_KOOPA_WITH_SHELL_CUSTOM, 277, -32, 287, 0, 0, 0, 0x00010000, bhvKoopa),
		OBJECT(MODEL_KOOPA_WITH_SHELL_CUSTOM, 75, -17, 6711, 0, 0, 0, 0x07000000, bhvKoopaToad),
		OBJECT(MODEL_KOOPA_WITH_SHELL_CUSTOM, 490, -32, 1917, 0, 0, 0, 0x00010000, bhvKoopa),
		OBJECT(MODEL_KOOPA_WITH_SHELL_CUSTOM, -1761, 0, 3538, 0, 0, 0, 0x00010000, bhvKoopa),
		...
		OBJECT(MODEL_NONE, -7460, 836, 3837, 0, 0, 0, 0x05000000, bhvLamp),
		OBJECT(MODEL_NONE, -7515, 670, 4703, 0, 0, 0, 0x05000000, bhvLamp),
		...
		OBJECT(MODEL_NONE, 14, 200, -4595, 0, 0, 0, 0x000A0000, bhvInstantActiveWarp),
	...
	AREA(3, bob_area_3),
		...
		WARP_NODE(0xF0, LEVEL_CASTLE_GROUNDS, 0x04, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_KOOPA_WITH_SHELL_CUSTOM, -4596, 434, 101, 0, 0, 0, 0x00010000, bhvKoopa),
		...
		OBJECT(MODEL_TOAD_BUILDER, -5336, 3067, -1900, 0, 0, 0, 0x00210000, bhvToad2),
		OBJECT(MODEL_TOAD_BUILDER, -4869, 3067, -1719, 0, 0, 0, 0x00220000, bhvToad2),
		OBJECT(MODEL_TOAD_BUILDER, -5649, 3067, -1554, 0, 0, 0, 0x00230000, bhvToad2),
