...
const GeoLayout bob_area_2_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, -3164, -684, 760),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, -5969, -26, 7059),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 679, -685, 7053),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 1628, -796, 8094),
