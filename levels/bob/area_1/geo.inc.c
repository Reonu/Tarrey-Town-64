...
const GeoLayout bob_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(4, -1749, 312, -2702, bob_dl_Cube_001_mesh_layer_4),
		GEO_TRANSLATE_NODE_WITH_DL(1, -2502, 3169, 1195, bob_dl_Cube_002_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(4, -1749, 312, -146, bob_dl_Cube_003_mesh_layer_4),
		...
		GEO_TRANSLATE_NODE_WITH_DL(4, 1573, 312, 98, bob_dl_Cube_009_mesh_layer_4),
