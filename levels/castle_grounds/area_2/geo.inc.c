...
const GeoLayout castle_grounds_area_2_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(1, 3055, 197, -2995, castle_grounds_dl_AWipHouse_001_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, 117, 124, -2086, castle_grounds_dl_Cube_001_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, 2576, 201, -3113, castle_grounds_dl_Cube_002_mesh_layer_1),
		...
		GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 2531, 275, -3113),
		GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(1, -2819, 180, -1072, castle_grounds_dl_Tent_004_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, -2334, 180, -2509, castle_grounds_dl_Tent_005_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, 1011, 180, -2632, castle_grounds_dl_Tent_006_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, 2677, 180, 277, castle_grounds_dl_Tent_007_mesh_layer_1),
