...
void scroll_castle_grounds_dl_000AAALake_003_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 7;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(castle_grounds_dl_000AAALake_003_mesh_layer_5_vtx_0);
...
void scroll_castle_grounds_dl_AAARiver_003_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 8;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(castle_grounds_dl_AAARiver_003_mesh_layer_5_vtx_0);
...
void scroll_castle_grounds() {
	...
	scroll_castle_grounds_dl_000AAALake_003_mesh_layer_5_vtx_0();
	scroll_castle_grounds_dl_AAARiver_003_mesh_layer_5_vtx_0();
}
