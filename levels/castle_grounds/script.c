...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_RED_FLAME, 256, 159, -1068, 0, 0, 0, 0x00000000, bhvFlame),
		OBJECT(MODEL_TOAD2, 237, 159, -1408, 0, 0, 0, 0x01000000, bhvToad2),
		OBJECT(MODEL_TOAD2, 74, 159, -1358, 0, 0, 0, 0x00000000, bhvToad2),
		OBJECT(MODEL_CASTLE_GROUNDS_WARP_PIPE, -628, 159, -1358, 0, 0, 0, 0x00010000, bhvWarpPipe),
