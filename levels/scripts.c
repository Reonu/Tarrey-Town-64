...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_FLOATING_BOX,            floating_box_geo),
    LOAD_MODEL_FROM_GEO(MODEL_STOOL,                    stool_geo),
    LOAD_MODEL_FROM_GEO(MODEL_PLANK,                   plank_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_KOOPA_SHELL_CUSTOM,      koopa_shell_custom_geo),
